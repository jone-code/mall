...
@Component
public class ReviewUserInterceptor implements HandlerInterceptor {

    public static final String HEADER_USER_ID = "X-User-Id";

    private final ObjectMapper objectMapper;

    public ReviewUserInterceptor(ObjectMapper objectMapper) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        try {
            ReviewUserContext.setUserId(Long.parseLong(raw.trim()));
            return true;
